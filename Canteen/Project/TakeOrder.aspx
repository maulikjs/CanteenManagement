 ...
 <td colspan="2" align="center">
  ...
  <tr><td colspan="2"><br /></td></tr>
   <tr><td colspan="2" align="center">
    <asp:GridView ID="GridView1" runat="server" Width="80%" OnRowCommand="GridView1_RowCommand" style="color: #000000; font-family: candara">
            <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
...
<tr><td align="right" width="40%">
    ...
    <table  width="80%">
     ...
     <td align="left" width="40%">
         <asp:TextBox ID="TextBox5" type="time" runat="server"></asp:TextBox>
     </td>
     </tr>
     <tr><td colspan="2">
