        ...
        else
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    tcell.Text = ds.Tables[0].Rows[i][0].ToString();
                    tcell.HorizontalAlign = HorizontalAlign.Center;
                    tcell1.Text = ds.Tables[0].Rows[i][1].ToString();
                    tcell1.HorizontalAlign = HorizontalAlign.Center;
                    tcell2.Text = ds.Tables[0].Rows[i][2].ToString();
                    tcell2.HorizontalAlign = HorizontalAlign.Center;
                    tcell3.Text = ds.Tables[0].Rows[i][3].ToString();
                    tcell3.HorizontalAlign = HorizontalAlign.Center;
                    amt = amt + Convert.ToDouble(ds.Tables[0].Rows[i][2].ToString());
