            ...
            else
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (flag == 1)
                        {
                            Page.ClientScript.RegisterStartupScript(GetType(), "magtype()", "alert('No enough Balance !!!')", true);
                                        ...
                                        if (ds2.Tables[0].Rows.Count > 0)
                                        {
                                            ...
                                            for (int j = 0; j < ds2.Tables[0].Rows.Count; j++)
                                            {
                                                ...
                                                if (ds3.Tables[0].Rows.Count > 0)
                                                {
                                                    ...
                                                    SqlCommand cmd;
                                                    con.Open();
                                                    op = "update Product set quantity='" + res + "' where prod_id='" + ds2.Tables[0].Rows[i][0].ToString() + "'";
                                                    cmd = new SqlCommand(op, con);
                                                    cmd.ExecuteNonQuery();
                                                    con.Close();
        ...
        else
        {
           ...
           // time = ct.ToString("hh:mm");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                SqlCommand cmd2;
                con.Open();
                string ui = "insert into transtemp values('" + TextBox3.Text + "','" + name + "','" + Label14.Text + "','" + amt + "','no')";
